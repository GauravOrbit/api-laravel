 ...
 */
class ChecksumPasswordGrant extends AbstractGrant
{
     ...
     * @var string
     */
    protected $identifier = 'checksum_devise_password';
    ...
    public function completeFlow()
    {
        ...
        $checkSum = $this->server->getRequest()->request->get('checksum', null);
        if (is_null($checkSum)) {
            throw new Exception\InvalidRequestException('checksum');
        }

        // Check if user's username and password are correct
        $userId = call_user_func($this->getVerifyCredentialsCallback(), $username, $password, $checkSum);
